...
{
    public partial class L1_L7 : Form
    {
        public L1_L7()
        {
            InitializeComponent();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            block.methodLeft(pictureBox7, player);
            block.methodRight(pictureBox7, player);
            ...
            block.methodTop(pictureBox18, player);
            block.methodHead(pictureBox18, player);
            block.methodTop(pictureBox19, player);
            block.methodHead(pictureBox19, player);
            block.methodTop(pictureBox20, player);
            block.methodHead(pictureBox20, player);
            block.methodTop(pictureBox21, player);
            block.methodHead(pictureBox21, player);
            block.methodTop(pictureBox22, player);
            block.methodHead(pictureBox22, player);
            block.methodTop(pictureBox23, player);
            block.methodHead(pictureBox23, player);
            block.methodTop(pictureBox24, player);
            block.methodHead(pictureBox24, player);
            block.methodTop(pictureBox25, player);
            block.methodHead(pictureBox25, player);
            block.methodTop(pictureBox26, player);
            block.methodHead(pictureBox26, player);
            block.methodTop(pictureBox27, player);
            block.methodHead(pictureBox27, player);
