...
{
    public partial class L1_L5 : Form
    {
        public L1_L5()
        {
            InitializeComponent();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            block.methodRight(pictureBox4, player);
            block.methodLeft(pictureBox4, player);
            block.methodRight(pictureBox6, player);
            block.methodLeft(pictureBox6, player);
            block.methodRight(pictureBox14, player);
            block.methodLeft(pictureBox14, player);
