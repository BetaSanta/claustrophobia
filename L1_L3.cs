...
{
    public partial class L1_L3 : Form
    {
        public L1_L3()
        {
            InitializeComponent();
        ...
        {
            ProgressClass.progressMass[0, 2] = 1;
            ProgressClass.timeMass[0, 2] = date.ToString("m:ss");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            block.methodRight2(pictureBox14, player);
            block.methodLeft2(pictureBox14, player);
            block.methodRight2(pictureBox5, player);
            block.methodLeft2(pictureBox5, player);
