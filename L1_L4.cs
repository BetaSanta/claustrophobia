...
{
    public partial class L1_L4 : Form
    {
        public L1_L4()
        {
            InitializeComponent();
        ...
        {
            ProgressClass.progressMass[0, 3] = 1;
            ProgressClass.timeMass[0, 3] = date.ToString("m:ss");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            block.methodRight(pictureBox5, player);
            block.methodLeft(pictureBox5, player);
            ...
            if (player.Left < EndLvl.Right && player.Right > EndLvl.Left && player.Location.Y <= EndLvl.Location.Y)
            {
